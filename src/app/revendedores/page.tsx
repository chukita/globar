...
const REQUISITOS = [
  ...
  },
  {
    ...
    desc: "Lo cargás cuando quieras desde el panel, junto con tus datos personales. Hace falta para cobrar, no para registrarte.",
    tag: "Para cobrar",
    accent: "#9B4A57",
    tint: "#FCE6E9",
  },
  ...
  },
  {
    ...
    desc: "Tenés que poder emitir factura por tus comisiones (Monotributo u otro régimen). Se declara al registrarte y es obligatorio para participar.",
    tag: "Obligatorio",
    accent: "#7B4FA6",
    tint: "#F0E8F8",
  },
  {
    n: "05",
    title: "CBU o alias a tu nombre",
    desc: "Una cuenta bancaria argentina, a nombre del mismo titular que emite la factura, para recibir las transferencias de tus comisiones.",
    tag: "Para cobrar",
    accent: "#9B4A57",
    tint: "#FCE6E9",
  },
